...
Deploying To Render
-------------------
Check out the [Render PostgreSQL documentation](https://render.com/docs/databases#connection-pooling) on connection pooling to learn how to deploy PgBouncer on Render.
